...
* [CloudRunWorker](src/CloudRunWorker) - Run a long-lived Temporal Worker on a Google Cloud Run worker pool, deriving worker identity and deployment version from Cloud Run metadata.
